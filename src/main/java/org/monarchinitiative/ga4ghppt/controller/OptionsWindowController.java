...
import org.monarchinitiative.ga4ghppt.io.FileDownloader;
import org.monarchinitiative.ga4ghppt.widgets.UserStringFetcher;
...
public class OptionsWindowController extends BaseController implements Initializable {
    ...
    public void downloadJson(ActionEvent e) {
        e.consume();
        File hpo2robotDir = Platform.getGa4ghPptDir();
