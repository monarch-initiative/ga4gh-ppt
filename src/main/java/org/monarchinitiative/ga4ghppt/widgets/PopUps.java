...
public class PopUps {
    ...
    public static Optional<File> selectGa4ghPptFileToSave(Window window) {
        final FileChooser filechooser = new FileChooser();
        filechooser.setInitialFileName("ga4ghppt.tsv");
        filechooser.setTitle("Set path to save Ga4ghPpt file");
